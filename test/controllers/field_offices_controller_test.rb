...
class FieldOfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field_office" do
    assert_difference('FieldOffice.count') do
      post field_offices_url, params: { field_office: { n400_forms_id: @field_office.n400_forms_id, name: @field_office.name, state: @field_office.state } }
    end
  ...
  test "should update field_office" do
    patch field_office_url(@field_office), params: { field_office: { n400_forms_id: @field_office.n400_forms_id, name: @field_office.name, state: @field_office.state } }
