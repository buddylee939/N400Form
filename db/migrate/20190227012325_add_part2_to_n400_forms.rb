class AddPart2ToN400Forms < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column :n400_forms, :name_change, :integer
    ...
    add_column :n400_forms, :social_security_num, :integer
    add_column :n400_forms, :uscis_num, :string
    add_column :n400_forms, :gender, :integer
    ...
    add_column :n400_forms, :physical_disability, :integer
    add_column :n400_forms, :years_or_older_50, :integer
    add_column :n400_forms, :years_or_older_55, :integer
    add_column :n400_forms, :years_or_older_65, :integer
  end
end
